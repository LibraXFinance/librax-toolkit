...
var Icon$h = function (props) { return (React.createElement(Svg, __assign({ viewBox: "0 0 18 20" }, props),
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#0095EC", backgroundDisabled: "#E9EAEB", backgroundAlt: "#0095EC", backgroundAlt2: "rgba(255, 255, 255, 0.7)", cardBorder: "#E7E3EB", contrast: "#191326", dropdown: "#F6F6F6", dropdownDeep: "#0083CF", invertedContrast: "#999999", input: "#0083CF", inputSecondary: "#eeeaf4", tertiary: "#0083CF", text: "#FAF5FA", textDisabled: "#BDC2C4", textSubtle: "#FFFFFF", disabled: "#E9EAEB", gradients: {
...
var socials = [
    {
        label: "Twitter",
        icon: "Twitter",
        href: "https://twitter.com/LibraXAvalanche",
    },
    {
        label: "Telegram",
        icon: "Telegram",
    ...
    return (React__default.createElement(ModalContainer, { minWidth: "320px" },
        ...
        React__default.createElement(ModalBody, { width: ["320px", null, "340px"] },
            ...
            React__default.createElement(Box, { p: "24px" },
                ...
                React__default.createElement(Button, __assign({ as: "a", href: "https://librax.gitbook.io", variant: "subtle", width: "100%" }, getExternalLinkProps()), t("Learn How to Connect"))))));
};
