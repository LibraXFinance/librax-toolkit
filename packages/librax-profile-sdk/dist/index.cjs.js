        ...
        this.getAchievements = function (account) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, graphqlRequest.request(profileSubgraphApi, graphqlRequest.gql(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n          query getUser($id: String!) {\n            user(id: $id) {\n              points {\n                id\n                campaignId\n                points\n              }\n            }\n          }\n        "], ["\n          query getUser($id: String!) {\n            user(id: $id) {\n              points {\n                id\n                campaignId\n                points\n              }\n            }\n          }\n        "]))), { id: account.toLowerCase() })];
                    case 1:
                        data = _a.sent();
...
exports.achievementBadges = achievementBadges;
exports.bunnyPlaceholder = img$z;
exports.default = PancakeProfileSdk;
exports.teamImages = teamImages;
